                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="post-thumb">
                                <a href="<?= Url::toRoute(['site/view','id'=>$article->article_id]);?>"><img src="<?= $article->getImage();?>" alt="" class="pull-left"></a>
                        ...
                        <div class="col-md-6">
                            <div class="post-content">
                                <header class="entry-header text-uppercase">
                                    ...
                                    <h1 class="entry-title"><a href="<?= Url::toRoute(['site/view','id'=>$article->article_id]);?>"><?= $article->title?></a></h1>
                                </header>
