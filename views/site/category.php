                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="post-thumb">
                                    <a href="<?= Url::toRoute(['site/view', 'id' => $article->article_id]); ?>"><img
                                                src="<?= $article->getImage(); ?>" alt="" class="pull-left entry-header"></a>
                            ...
                            <div class="col-md-6">
                                <div class="post-content">
                                    <header class="entry-header text-uppercase">
                                        <h6>
                                            <a href="<?= Url::toRoute(['site/category', 'id' => $article->sport->sport_id]); ?>"> <?= $article->sport->sport ?></a>
                                        </h6>
